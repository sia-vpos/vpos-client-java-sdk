...
public class Application {
    ...
    private static final String URL_REDIRECT = "https://atpostest.ssb.it/atpos/pagamenti/main?PAGE=LAND";
    ...
    public static void main(String[] args) throws COFException {
        VPOSClient vposClient = new VPOSSimpleClient(MAC_KEY_VPOS, );
        System.out.println(vposClient.getHtmlPaymentDocument(buildPaymentTest()));
    }
