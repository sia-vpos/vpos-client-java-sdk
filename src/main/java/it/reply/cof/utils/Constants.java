...
public class Constants {
    ...
    public static final class AposConstant {
        ...
        public static final String LOCKCARD = "LOCKCARD";
        public static final String COMMIS = "COMMIS";
        public static final String ORDDESCR = "ORDDESCR";
        public static final String VSID = "VSID";
        public static final String OPDESCR = "OPDESCR";
        public static final String REMAININGDURATION = "REMAININGDURATION";
        public static final String USERID = "USERID";
        public static final String BP_POSTEPAY = "BP_POSTEPAY";
        public static final String BP_CARDS = "BP_CARDS";
