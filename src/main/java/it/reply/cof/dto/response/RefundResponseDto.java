...
public class RefundResponseDto {
    ...
    private String authorizatedAmount;
    ...
    public String getOperationMAC() {
        return operationMAC;
    }

    public void setOperationMAC(String operationMAC) {
    ...
    public String getAuthorizatedAmount() {
        return authorizatedAmount;
    }

    public void setAuthorizatedAmount(String authorizationAmount) {
        this.authorizatedAmount = authorizationAmount;
    }
    ...
    public String getResponseCodedIso() {
        return responseCodedIso;
    }
