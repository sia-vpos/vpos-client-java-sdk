...
public final class Operations {
    ...
    public static final class PARAMETERS {
        ...
        public static final class THREEDSMTDNOTIFURL{
            public static final String NAME = "THREEDSMTDNOTIFURL";

        }

        public static final class CHALLENGEWINSIZE{
            public static final String NAME = "CHALLENGEWINSIZE";

        }

        public static final class NOTIFURL{
            public static final String NAME = "NOTIFURL";

        }

        public static final class THREEDSTRANSID{
            public static final String NAME = "THREEDSTRANSID";
        ...
        public static final class THREEDSDATA{
            public static final String NAME = "THREEDSDATA";
